...
class Game:
    ...
    def display_rules(self):
        print('''Remember the rules: Scissors cuts Paper, Scissors decapitates Lizard Paper covers Rock, Paper disproves Spock Rock crushes Lizard, Rock crushes Scissors Lizard poisons Spock, Lizard eats Paper Spock smashes Scissors, Spock vaporizes Rock Ready to play? ''')
    ...
    def play_game(self):
        ...
        while current_round < number_of_rounds:         
            current_round += 1
            print(f''' Round {current_round}: {self.user_1.name} choose gesture: ''')
